...
for iT = 1:2
    ...
    if iT==1; 
        title('Type I', 'FontSize', 6, 'Color', [0.494 0.494 0.494]);
        ...
        set(gca,'visible','off');
    elseif iT==2
        title('Type II', 'FontSize', 6, 'Color', [0 0 0]);
...
print(fHandle, '-depsc', 'C:\Users\Lapis\OneDrive\project\workingmemory_interneuron\manuscript\Neuron\Fig\extfig7e.eps');