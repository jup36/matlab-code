...
text(title_pos, nC(2)+50, 'Time from delay onset (s)', ...
...
text(title_pos, nC(4)+50, 'Time from delay onset (s)', ...
    'FontSize', font_m, 'Color', 'k', 'HorizontalAlign', 'center');
...
set(h, 'Box', 'off', 'TickDir', 'out', 'FontSize', font_s, 'LineWidth', 0.2, ...
    'XTick', [], 'XColor', 'w', ...
    'YTick', [], 'YColor', 'w');
set(h([3 4 7 8]), 'XColor', 'k', 'XTick', [1 101 201 301], 'XTickLabel', [0 1 2 3]);

print(gcf,'-dtiff', '-r600', 'colormap_delay_PCFS.tif');
close all;
